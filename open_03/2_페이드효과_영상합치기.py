...
effect_frames = int(fps * 2)     # 1sec -> 30frame, 2sec-> 60frame
...
fourcc = cv2.VideoWriter_fourcc(*'DIVX') # MPEG-4
...
for i  in range(effect_frames):
    ...
    frame[ :, 0:dx, : ] = frame2[ :, 0:dx, : ]  # Blossoms.mp4
    frame[ :, dx:w, : ] = frame1[ :, dx:w, : ]  # Jellyfish.mp2
    out.write(frame)
